...
PROMPT='%{$fg[green]%}%~%{$reset_color%} %{$reset_color%}%B$%b '
...
piip=$(~/Programing/Scripts/getPiIp4.sh &)
# aliases
alias lls="ls -a"
alias :q="clear"
#alias sudo="sudo -E"
#alias conpi="ssh pi@$piip"
alias conpi="ssh -X pi@$piip"
alias clipcopy="xclip -selection clipboard -r"
